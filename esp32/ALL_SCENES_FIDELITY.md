...
20. [ ] **Prove panel performance after background batching.** Re-run hashes,
    ...
    RC4 keeps the native scene region unchanged and clears only the reserved
...
The RC4 sidebar and release work does not change scene composition: the 640x480
